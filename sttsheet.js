...
var regedit;
try { regedit = require('regedit'); } catch(err) { regedit = null; }
...
var Excel;
try { Excel = require('exceljs'); } catch (err) { Excel = null; }
...
const optionDefinitions = [
	...
	{ name: 'excel', alias: 'e', type: String, defaultValue: null },
	{ name: 'accesstoken', type: String, defaultOption: true }
];

const options = commandLineArgs(optionDefinitions);

if (options.excel && (Excel == null))
{
	console.error('In order to use excel output, you need to install the exceljs module first!');
	return;
}
